...
let package = Package(
    ...
    products: [
        ...
        .library(name: "ExtensionsFeature", targets: ["ExtensionsFeature"]),
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                ...
                "ExtensionsFeature", "TransferFeature",
                "TsuyomiCore", "TsuyomiProtocol", "TsuyomiSource", "TsuyomiUI"
            ]
        ),
        .testTarget(
            name: "TsuyomiAppTests",
            dependencies: ["BookFeature", "ReaderFeature", "SearchFeature", "TsuyomiApp"]
        )
    ]
)
