...
enum NetworkFixture {
    ...
    /// The leading bytes the gateway sniffs: a JPEG SOI + JFIF marker, and a RIFF/WEBP header.
    static let jpegHead = Data([0xFF, 0xD8, 0xFF, 0xE0, 0x00, 0x10, 0x4A, 0x46, 0x49, 0x46, 0x00, 0x01])
    static let webpHead = Data([0x52, 0x49, 0x46, 0x46, 0x24, 0x00, 0x00, 0x00, 0x57, 0x45, 0x42, 0x50])
